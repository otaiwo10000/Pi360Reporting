...
(function () {
    ...
    angular
        .module("fintrak")
        .controller("ReportController020",
    ...
    function ReportController020($scope, $state, viewModelHelper, $stateParams, validator, Excel, $timeout, $modal, $modalInstance) {
        var vm = this;
        vm.viewModelHelper = viewModelHelper;
        vm.parentController = $scope.$parent;


        vm.view = 'report020-view';
        vm.viewName = 'Report020';
        ...
        vm.channelList = [
            ...
            { value: "Internet Banking", name: "Internet Banking" },
            { value: "Mobile", name: "Mobile" },
            { value: "Oxygen", name: "Oxygen" },
            { value: "Paychoice", name: "Paychoice" },
            { value: "Payment and Collections", name: "Payment and Collections" },
            { value: "POS", name: "POS" },
            { value: "USSD", name: "USSD" },
            { value: "ZeroData", name: "ZeroData" }
        ];
        ...
        var defaultreportSet020 = function () {
        ...
        vm.toggleReportPage = function () {
            ...
            document.getElementById("report020").hidden = vm.tToggle;
            toggleTextFunc();
        };
