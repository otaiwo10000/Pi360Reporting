...
(function () {
    ...
    angular
        .module("fintrak")
        .controller("ReportController035",
    ...
    function ReportController035($scope, $state, viewModelHelper, $stateParams, validator, yearsService, Excel, $timeout, $modal, $modalInstance) {
        var vm = this;
        vm.viewModelHelper = viewModelHelper;
        vm.parentController = $scope.$parent;

        vm.view = 'report035-view';
        vm.viewName = 'Report035';
        ...
        vm.startperiodmodel = null;
        vm.endperiodmodel = null;
        vm.startperiodmodel2 = vm.startperiodmodel;
        vm.endperiodmodel2 = vm.endperiodmodel;
        ...
        vm.startyearmodel = 0;
        vm.endyearmodel = 0;
        vm.startyearmodel2 = vm.startyearmodel;
        vm.endyearmodel2 = vm.endyearmodel;
        ...
        var defaultreportSet035 = function () {
