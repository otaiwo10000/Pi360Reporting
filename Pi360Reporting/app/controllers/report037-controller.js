...
(function () {
    ...
    angular
        .module("fintrak")
        .controller("ReportController037",
            ['$scope', '$state', 'viewModelHelper', '$stateParams', 'validator', 'yearsService', 'Excel', '$timeout', '$modal',
                ReportController037]);


    function ReportController037($scope, $state, viewModelHelper, $stateParams, validator, yearsService, Excel, $timeout, $modal, $modalInstance) {
        var vm = this;
        ...
        vm.productsupercaptionmodel = '';
        vm.productsupercaptionmodel2 = vm.productsupercaptionmodel;
        ...
        var productSuperCaptionFunc = function () {

            //vm.viewModelHelper.apiGet('api/reportprocedure/loggedinusername/' + vm.loggedinUserName, null,
            vm.viewModelHelper.apiGet('api/reportprocedure/productssupercation', null,
                function (result) {
                    vm.pscList = result.data;
                },
                function (result) {
        ...
        var defaultreportSet037 = function () {
        ...
        vm.toggleReportPage = function () {
            ...
            document.getElementById("report037").hidden = vm.tToggle;
            toggleTextFunc();
        };
