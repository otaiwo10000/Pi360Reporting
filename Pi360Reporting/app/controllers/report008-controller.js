...
(function () {
    ...
    angular
        .module("fintrak")
        .controller("ReportController008",
    ...
    function ReportController008($scope, $state, viewModelHelper, $stateParams, validator, yearsService, Excel, $timeout, $modal, $modalInstance) {
        var vm = this;
        vm.viewModelHelper = viewModelHelper;
        vm.parentController = $scope.$parent;

        vm.view = 'report008-view';
        vm.viewName = 'Report008';
        ...
        var defaultreportSet008 = function () {
