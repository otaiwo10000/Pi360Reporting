...
(function () {
    ...
    angular
        .module("fintrak")
        .controller("ReportController027",
            ['$scope', '$state', 'viewModelHelper', '$stateParams', 'validator', 'yearsService', 'Excel', '$timeout', '$modal',
                ReportController027]);


    function ReportController027($scope, $state, viewModelHelper, $stateParams, validator, yearsService, Excel, $timeout, $modal, $modalInstance) {
        var vm = this;
        ...
        var defaultreportSet027 = function () {
