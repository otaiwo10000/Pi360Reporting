...
(function () {
    ...
    angular
        .module("fintrak")
        .controller("ReportController018",
    ...
    function ReportController018($scope, $state, viewModelHelper, $stateParams, validator, yearsService, Excel, $timeout, $modal, $modalInstance) {
        var vm = this;
        ...
        vm.view = 'report018-view';
        vm.viewName = 'Report018';
        ...
        vm.typeList = [{ value: "BS", name: "Balancesheet" }, { value: "PL", name: "Income" }, { value: "OT", name: "Other MPR Captions" }];

        vm.metrictypeList = [{ value: "actual", name: "Actual" }, { value: "average", name: "Average" }];
        ...
        var defaultreportSet018 = function () {
        ...
        vm.toggleReportPage = function () {
            ...
            document.getElementById("report018").hidden = vm.tToggle;
            toggleTextFunc();
        };
