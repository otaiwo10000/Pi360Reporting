...
(function () {
    ...
    angular
        .module("fintrak")
        .controller("ReportController004",
    ...
    function ReportController004($scope, $state, viewModelHelper, $stateParams, validator, yearsService, Excel, $timeout, $modal, $modalInstance) {
        var vm = this;
        ...
        vm.toggleReportPage = function () {
            ...
            document.getElementById("report004").hidden = vm.tToggle;
            toggleTextFunc();
        };
