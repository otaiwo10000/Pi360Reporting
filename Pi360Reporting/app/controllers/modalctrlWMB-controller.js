...
(function () {
    ...
    function ModalCtrlWMB($rootScope, $scope, $state, viewModelHelper, $stateParams, $modal, $modalInstance, validator, Excel, $timeout) {
        var vm = this;
        ...
        vm.directorate = 'NULL'; vm.region = null; vm.zone = null; vm.branch = null; vm.acctofficer = null; vm.team = null; 
        vm.searchval = 'NULL';
        ...
        vm.tsOnPageLoadFunc = function () {
            ...
            vm.directorate = null; vm.region = null; vm.zone = null;  vm.branch = null; vm.acctoffice = null; vm.team = null;
            ...
            vm.viewModelHelper.apiGet('api/teamstructure/teamstructurebymiscodelevelyearWMB', null,
                ...
                function (res) {
                    ...
                    angular.forEach(vm.teamstructuredata, function (value, key) {
                        ...
                        //});
                         ...
                         angular.forEach(value.ZoneList, function (e, f) {
                            vm.ZoneList.push({ Code: e.Code, Name: e.Name });
                        });
        ...
        vm.tsOnSelectFunc = function (miscode, level, misname) {
            ...
            if (vm.selectedlevel.toString() === '0') {
                ...
                vm.viewModelHelper.apiGet('api/teamstructure/teamstructurebyselectionWMB/' + vm.selectedmiscode + '/' + vm.selectedyear + '/' + vm.selectedlevel + '/' + vm.selectedmisname, null,
                    //vm.viewModelHelper.apiGet('api/mprbalancesheet/availablemprbalancesheet/' + vm.number + '/' + vm.RunDate.toDateString() + '/' + vm.ToDate.toDateString(), null,
                    function (res) {
                        vm.teamstructuredata = res.data;
            ...
            else if (vm.selectedlevel.toString() === '5') {
            ...
            //else if (vm.selectedlevel.toString() === '6') {
            ...
            //            angular.forEach(vm.teamstructuredata, function (value, key) {
            //                angular.forEach(value.RegionList, function (i, j) {
            //                    vm.RegionList.push({ Code: i.Code, Name: i.Name });
            //                });
            ...
            //}
            ...
            else if (vm.selectedlevel.toString() === '4') {
                ...
                vm.viewModelHelper.apiGet('api/teamstructure/teamstructurebyselectionWMB/' + vm.selectedmiscode + '/' + vm.selectedyear + '/' + vm.selectedlevel + '/' + encodeURIComponent(vm.selectedmisname), null,
                    //vm.viewModelHelper.apiGet('api/mprbalancesheet/availablemprbalancesheet/' + vm.number + '/' + vm.RunDate.toDateString() + '/' + vm.ToDate.toDateString(), null,
                    function (res) {
                        vm.teamstructuredata = res.data;
                        ...
                        angular.forEach(vm.teamstructuredata, function (value, key) {
                            ...
                            angular.forEach(value.ZoneList, function (i, j) {
                                vm.ZoneList.push({ Code: i.Code, Name: i.Name });
                            });
                            ...
                            angular.forEach(value.TeamList, function (e, f) {
                                vm.TeamList.push({ Code: e.Code, Name: e.Name });
                            });
            ...
            else if (vm.selectedlevel.toString() === '3') {
                $scope.finallySelectedLevelCodeDropDown = 'ZON';
            ...
            else if (vm.selectedlevel.toString() === '2') {
            ...
            else if (vm.selectedlevel.toString() === '1') {
        ...
        $scope.dashboardriskassetGlobalFunc_childmethod = function () {
            $rootScope.$emit("dashboardriskassetGlobalFunc_ParentMethod", {});
        };

        $scope.dashboardincomeGlobalFunc_childmethod = function () {
            $rootScope.$emit("dashboardincomeGlobalFunc_ParentMethod", {});
        };
        ...
        $rootScope.okGlobal = function () {
            ...
            switch (vm.uirouteparam) {
                ...
                case 'income':
                    $scope.dashboardincomeGlobalFunc_childmethod();
                    break;

                case 'riskasset':
                    $scope.dashboardriskassetGlobalFunc_childmethod();
            }
            //$scope.dashboarddepositGlobalFunc_childmethod();
            //$scope.dashboardexpenseGlobalFunc_childmethod();
            //$scope.dashboardratiosGlobalFunc_childmethod();
