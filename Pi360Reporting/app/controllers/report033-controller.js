...
(function () {
    ...
    angular
        .module("fintrak")
        .controller("ReportController033",
    ...
    function ReportController033($scope, $state, viewModelHelper, $stateParams, validator, yearsService, Excel, $timeout, $modal, $modalInstance) {
        var vm = this;
        vm.viewModelHelper = viewModelHelper;
        vm.parentController = $scope.$parent;

        vm.view = 'report033-view';
        vm.viewName = 'Report033';
        ...
        var defaultreportSet033 = function () {
