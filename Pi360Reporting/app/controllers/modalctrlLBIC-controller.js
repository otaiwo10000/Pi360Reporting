...
(function () {
    ...
    function ModalCtrlLBIC($rootScope, $scope, $state, viewModelHelper, $stateParams, $modal, $modalInstance, validator, Excel, $timeout) {
        var vm = this;
        vm.viewModelHelper = viewModelHelper;
        vm.parentController = $scope.$parent;

        vm.view = 'modalctrlLBIC-view';
        ...
        vm.directorate = 'NULL'; vm.region = 'NULL'; vm.division = 'NULL'; vm.branch = 'NULL'; vm.team = 'NULL'; vm.acctofficer = 'NULL';
        vm.searchval = 'NULL';
        ...
        vm.tsOnPageLoadFunc = function () {
            ...
            vm.directorate = null; vm.region = null; vm.division = null; vm.branch = null; vm.team = null; vm.acctoffice = null;
            ...
            vm.viewModelHelper.apiGet('api/teamstructure/teamstructurebymiscodelevelyearLBIC', null,
        ...
        vm.tsOnSelectFunc = function (miscode, level, misname) {
            ...
            if (vm.selectedlevel === '0') {
                ...
                vm.viewModelHelper.apiGet('api/teamstructure/teamstructurebyselectionLBIC/' + vm.selectedmiscode + '/' + vm.selectedyear + '/' + vm.selectedlevel + '/' + vm.selectedmisname, null,
                    //vm.viewModelHelper.apiGet('api/mprbalancesheet/availablemprbalancesheet/' + vm.number + '/' + vm.RunDate.toDateString() + '/' + vm.ToDate.toDateString(), null,
                    function (res) {
                        vm.teamstructuredata = res.data;
                ...
                vm.viewModelHelper.apiGet('api/teamstructure/teamstructurebyselectionLBIC/' + vm.selectedmiscode + '/' + vm.selectedyear + '/' + vm.selectedlevel + '/' + encodeURIComponent(vm.selectedmisname), null,
                    //vm.viewModelHelper.apiGet('api/mprbalancesheet/availablemprbalancesheet/' + vm.number + '/' + vm.RunDate.toDateString() + '/' + vm.ToDate.toDateString(), null,
                    function (res) {
                        vm.teamstructuredata = res.data;
