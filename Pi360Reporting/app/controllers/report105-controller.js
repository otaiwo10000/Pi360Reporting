...
(function () {
    ...
    angular
        .module("fintrak")
        .controller("ReportController105",
    ...
    function ReportController105($scope, $state, viewModelHelper, $stateParams, validator, Excel, $timeout, $modal, $modalInstance) {
        var vm = this;
        vm.viewModelHelper = viewModelHelper;
        vm.parentController = $scope.$parent;


        vm.view = 'report105-view';
        vm.viewName = 'Report105';
        ...
        var defaultreportSet105 = function () {
        ...
        vm.toggleReportPage = function () {
            ...
            document.getElementById("report105").hidden = vm.tToggle;
            toggleTextFunc();
        };
