...
(function () {
    ...
    angular
        .module("fintrak")
        .controller("ReportController028",
            ['$scope', '$state', 'viewModelHelper', '$stateParams', 'validator', 'yearsService', 'Excel', '$timeout', '$modal',
                ReportController028]);


    function ReportController028($scope, $state, viewModelHelper, $stateParams, validator, yearsService, Excel, $timeout, $modal, $modalInstance) {
        var vm = this;
        ...
        vm.yearmodel = 0;
        vm.periodmodel = 0;
        vm.startdatemodel = "2018-01-01";
        vm.enddatemodel = "2018-01-01";
        vm.yearmodel2 = 0;
        vm.periodmodel2 = 0;
        ...
        var defaultreportSet028 = function () {
