...
(function () {
    ...
    angular
        .module("fintrak")
        .controller("ReportController106",
    ...
    function ReportController106($scope, $state, viewModelHelper, $stateParams, validator, Excel, $timeout, $modal, $modalInstance) {
        var vm = this;
        vm.viewModelHelper = viewModelHelper;
        vm.parentController = $scope.$parent;


        vm.view = 'report106-view';
        vm.viewName = 'Report106';
        ...
        vm.channelmodel = "Alat"; 
        vm.channelmodel2 = vm.channelmodel;

        //vm.currencymodel = "All Currencies";
        //vm.currencymodel2 = vm.currencymodel;

        vm.teamnamemodel2 = "nu";
        ...
        var defaultreportSet106 = function () {
        ...
        vm.toggleReportPage = function () {
            ...
            document.getElementById("report106").hidden = vm.tToggle;
            toggleTextFunc();
        };
