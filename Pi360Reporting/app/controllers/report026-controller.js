...
(function () {
    ...
    angular
        .module("fintrak")
        .controller("ReportController026",
        ['$scope', '$state', 'viewModelHelper', '$stateParams', 'validator', 'yearsService', 'Excel', '$timeout', '$modal',
            ReportController026]);
    

    function ReportController026($scope, $state, viewModelHelper, $stateParams, validator, yearsService, Excel, $timeout, $modal, $modalInstance) {
        var vm = this;
        ...
        vm.reportlevelmodel = null;  
        vm.reportlevelmodel2 = '00';  //as default to be sent but not to be visible to users
        ...
        var defaultreportSet026 = function () {
        ...
        vm.toggleReportPage = function () {
            ...
            document.getElementById("report026").hidden = vm.tToggle;
            toggleTextFunc();
        };
