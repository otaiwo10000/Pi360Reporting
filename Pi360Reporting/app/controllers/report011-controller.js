...
(function () {
    ...
    angular
        .module("fintrak")
        .controller("ReportController011",
    ...
    function ReportController011($scope, $state, viewModelHelper, $stateParams, validator, yearsService, Excel, $timeout, $modal, $modalInstance) {
        var vm = this;
        ...
        vm.view = 'report011-view';
        vm.viewName = 'Report011';
        vm.menuObj = {};
        vm.yearperiodObj = {};    
        ...
        vm.periodmodel2 = 0;
        vm.yearmodel2 = 0;
        vm.statemodel2 = "montly";
        vm.statemodel = "montly";
        ...
        var defaultreportSet011 = function () {
        ...
        vm.toggleReportPage = function () {
            ...
            document.getElementById("report011").hidden = vm.tToggle;
            toggleTextFunc();
        };
