...
(function () {
    ...
    angular
        .module("fintrak")
        .controller("ReportController102",
    ...
    function ReportController102($scope, $state, viewModelHelper, $stateParams, validator, Excel, $timeout, $modal, $modalInstance) {
        var vm = this;
        vm.viewModelHelper = viewModelHelper;
        vm.parentController = $scope.$parent;


        vm.view = 'report102-view';
        vm.viewName = 'Report102';
        ...
        var defaultreportSet102 = function () {
        ...
        vm.toggleReportPage = function () {
            ...
            document.getElementById("report102").hidden = vm.tToggle;
            toggleTextFunc();
        };
