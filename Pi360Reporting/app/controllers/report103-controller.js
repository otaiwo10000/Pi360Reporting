...
(function () {
    ...
    angular
        .module("fintrak")
        .controller("ReportController103",
    ...
    function ReportController103($scope, $state, viewModelHelper, $stateParams, validator, Excel, $timeout, $modal, $modalInstance) {
        var vm = this;
        vm.viewModelHelper = viewModelHelper;
        vm.parentController = $scope.$parent;


        vm.view = 'report103-view';
        vm.viewName = 'Report103';
        ...
        var defaultreportSet103 = function () {
        ...
        vm.toggleReportPage = function () {
            ...
            document.getElementById("report103").hidden = vm.tToggle;
            toggleTextFunc();
        };
