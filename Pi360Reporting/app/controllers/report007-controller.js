...
(function () {
    ...
    angular
        .module("fintrak")
        .controller("ReportController007",
    ...
    function ReportController007($scope, $state, viewModelHelper, $stateParams, validator, yearsService, Excel, $timeout, $modal, $modalInstance) {
        var vm = this;
        vm.viewModelHelper = viewModelHelper;
        vm.parentController = $scope.$parent;

        vm.view = 'report007-view';
        vm.viewName = 'Report007';
        ...
        var defaultreportSet007 = function () {
        ...
        vm.toggleReportPage = function () {
            ...
            document.getElementById("report007").hidden = vm.tToggle;
            toggleTextFunc();
        };
