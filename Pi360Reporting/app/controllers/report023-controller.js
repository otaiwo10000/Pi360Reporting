...
(function () {
    ...
    angular
        .module("fintrak")
        .controller("ReportController023",
    ...
    function ReportController023($scope, $state, viewModelHelper, $stateParams, validator, Excel, $timeout, $modal, $modalInstance) {
        var vm = this;
        vm.viewModelHelper = viewModelHelper;
        vm.parentController = $scope.$parent;


        vm.view = 'report023-view';
        vm.viewName = 'Report023';
        ...
        vm.BranchNamemodel = "";  
        vm.BranchNamemodel2 = vm.BranchNamemodel;
        ...
        var defaultreportSet023 = function () {
        ...
        vm.toggleReportPage = function () {
            ...
            document.getElementById("report023").hidden = vm.tToggle;
            toggleTextFunc();
        };
