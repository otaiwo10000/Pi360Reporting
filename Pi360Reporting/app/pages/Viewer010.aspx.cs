...
{
    public partial class Viewer010 : System.Web.UI.Page
    {
            ...
            try
            {
                ...
                {                    
                   ...
                   // string Type = "bs";
                    ...
                    reportViewer010.ServerReport.ReportServerUrl = new Uri(reportServerUrl);
                    reportViewer010.ServerReport.ReportServerCredentials = new ReportCredentials(userName, password, domain);
                    reportViewer010.ServerReport.ReportPath = string.Format(reportPath, reportId);
                    //reportViewer.ServerReport.ReportPath = "/reportPath/reportId";
                    reportViewer010.ProcessingMode = ProcessingMode.Remote;
                    reportViewer010.ShowCredentialPrompts = false;
                    ...
                    reportParameter[3] = new ReportParameter("NRFF", NRFF);
                    reportParameter[4] = new ReportParameter("Path", Path);
                    reportParameter[5] = new ReportParameter("Period", Period);
                    reportParameter[6] = new ReportParameter("Type", Type);
                    reportParameter[7] = new ReportParameter("Unit", Unit);
                    reportParameter[8] = new ReportParameter("Year", Year);


                    //==== NOTE: for report on server, use the below ============
                    reportViewer010.ServerReport.SetParameters(reportParameter);

                    reportViewer010.ServerReport.Refresh();
