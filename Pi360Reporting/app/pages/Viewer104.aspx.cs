...
{
    public partial class Viewer104 : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                if (!IsPostBack)
                {
                    ...
                    reportViewer104.ServerReport.ReportServerUrl = new Uri(reportServerUrl);
                    reportViewer104.ServerReport.ReportServerCredentials = new ReportCredentials(userName, password, domain);
                    reportViewer104.ServerReport.ReportPath = string.Format(reportPath, reportId);
                    //reportViewer.ServerReport.ReportPath = "/reportPath/reportId";
                    reportViewer104.ProcessingMode = ProcessingMode.Remote;
                    reportViewer104.ShowCredentialPrompts = false;
                    ...
                    reportViewer104.ServerReport.SetParameters(reportParameter);

                    reportViewer104.ServerReport.Refresh();
