...
{
    public partial class Viewer011 : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                {                    
                    ...
                    reportViewer011.ServerReport.ReportServerUrl = new Uri(reportServerUrl);
                    reportViewer011.ServerReport.ReportServerCredentials = new ReportCredentials(userName, password, domain);
                    reportViewer011.ServerReport.ReportPath = string.Format(reportPath, reportId);
                    //reportViewer.ServerReport.ReportPath = "/reportPath/reportId";
                    reportViewer011.ProcessingMode = ProcessingMode.Remote;
                    reportViewer011.ShowCredentialPrompts = false;
                    ...
                    reportParameter[4] = new ReportParameter("State", State);
                    reportParameter[5] = new ReportParameter("Year", Year);


                    //==== NOTE: for report on server, use the below ============
                    reportViewer011.ServerReport.SetParameters(reportParameter);

                    reportViewer011.ServerReport.Refresh();
