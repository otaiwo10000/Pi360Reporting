...
{
    public partial class Viewer024 : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                {                    
                    ...
                    reportViewer024.ServerReport.ReportServerUrl = new Uri(reportServerUrl);
                    reportViewer024.ServerReport.ReportServerCredentials = new ReportCredentials(userName, password, domain);
                    reportViewer024.ServerReport.ReportPath = string.Format(reportPath, reportId);
                    //reportViewer.ServerReport.ReportPath = "/reportPath/reportId";
                    reportViewer024.ProcessingMode = ProcessingMode.Remote;
                    reportViewer024.ShowCredentialPrompts = false;
                    ...
                    reportParameter[4] = new ReportParameter("Product", Product);
                    ...
                    reportViewer024.ServerReport.SetParameters(reportParameter);

                    reportViewer024.ServerReport.Refresh();
