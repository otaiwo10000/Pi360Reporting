...
{
    public partial class Viewer027 : System.Web.UI.Page
    {
            ...
            try
            {
                ...
                {                    
                   ...
                   // string SuperCaption = Request.QueryString["productsupercaption"].ToString();
                    ...
                    reportViewer027.ServerReport.ReportServerUrl = new Uri(reportServerUrl);
                    reportViewer027.ServerReport.ReportServerCredentials = new ReportCredentials(userName, password, domain);
                    reportViewer027.ServerReport.ReportPath = string.Format(reportPath, reportId);
                    //reportViewer.ServerReport.ReportPath = "/reportPath/reportId";
                    reportViewer027.ProcessingMode = ProcessingMode.Remote;
                    reportViewer027.ShowCredentialPrompts = false;
                   ...
                   // reportParameter[4] = new ReportParameter("SuperCaption", SuperCaption);
                    ...
                    reportViewer027.ServerReport.SetParameters(reportParameter);

                    reportViewer027.ServerReport.Refresh();
